          ...
          */
            ...
            gapi.client.calendar.events.list({
              ...
              */
              ...
              gapi.client.calendar.calendarList.list().then(promise => 
               {
                 ...
                 {
                   //Creates new calendarObjects while saving only the necessary information
                   userCalendars.push(new calendarObject(promise.result.items[i].summary, promise.result.items[i].id, promise.result.items[i].timeZone))
                }
                   printConfirmation();
               }
                 )
              ...
              //updateWebPage(); //Consider putting this inside one of the api calls. This will call a function that gets rid of the login button and replaces it wiht new elements
        })
      }
    )};
...
function App() {
//   const [calendar, chooseCalendars] = useState([
//     { name: 'my name jeff', id: 1, selected: false }, 
//     {name: 'my name john', id: 2, selected: false},
//     {name: 'my name wonsuk', id: 3, selected: false}
// ])
  ...
  return (
    <div className="App">
      <CheckBox calendars={calendar}></CheckBox>
      <button onClick={handleClick}>Login</button>
      <button onClick={updateCalendars}>Show Calendars</button>
    </div>
  );
